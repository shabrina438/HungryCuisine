<section class="fnavbar">
		...
		<nav class="green">
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">HungryCuisine</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="index.php" class="hvr-grow">Home</a></li>
		        <li><a href="about-hungry-cuisine.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to these numbers: 02-55046678, 09666775577, 01755587224. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		        
		        <?php

		        	if (isset($_SESSION['user'])) {
		        		echo '<li><a href="#" class="hvr-grow">Hi, '.$_SESSION['user'].'</a></li>
                        <li><a href="orders.php" class="hvr-grow">My Orders</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="about-hungry-cuisine.php">About Us</a></li>
	        <li><a href="food-categories.php">Categories</a></li>
	        <li><a href="foods.php">Foods</a></li>
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to these numbers: 02-55046678, 09666775577, 01755587224. Check the bottom Footer Section of the website for more info.');">Contact</a></li>

			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				        <img class="activator" src="images/f<?php echo $arr_all[$i+$j-2]['id']; ?>.jpg">
				    </div>
				    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4"><a class="black-text" href=""><h5><?php echo $arr_all[$i+$j-2]['fname']; ?></h5></a><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>This is a popular Food of Hungry Cuisine. Order Now to Grab a bite of it!</p>
			        </div>
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>&name=<?php echo $arr_all[$i+$j-2]['fname']; ?>&price=<?php echo $arr_all[$i+$j-2]['price']; ?>" style="background: green;" class="btn waves-effect waves-block waves-light" href="">Order Now! (<?php echo $arr_all[$i+$j-2]['price']; ?> BDT)</a>
			        </div>
				    </div>

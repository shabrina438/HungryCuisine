...
$sql = "INSERT INTO orders(order_id,user_id,food_id,food_name,user_name,price, timestamp) VALUES(?,?,?,?,?,?,?)";

$query  = $pdoconn->prepare($sql);

if ($query->execute([$order_id, $user_id, $food_id, $food_name, $user_name, $price, $timest])) {
